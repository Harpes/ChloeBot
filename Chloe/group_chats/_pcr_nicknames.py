CHARA_NAME = {
    ...
    1133: ['七七香(夏日)', 'ナナカ(サマー)', 'Nanaka(Summer)', '泳装娜娜卡', '泳装77k', '泳装77香', '水娜娜卡', '水77k', '水77香', '水七七香', '夏日七七香', '水nnk'],
    ...
    1155: ['可可萝(华服)', 'コッコロ(儀装束）', 'Kokkoro(Costume)', '礼服妈', '花嫁妈', '华服妈', '礼服可可萝', '花嫁可可萝', '华服可可萝', '礼妈'],
    1156: ['优衣(华服)', 'ユイ(儀装束)', 'Yui(Costume)', '礼服ue', '花嫁ue', '华服ue', '礼服优衣', '花嫁优衣', '华服优衣', '礼衣'],
    ...
    1160: ['真步(灰姑娘)', 'マホ(シンデレラ)', 'Maho(Cinderella)', '礼服狐狸', '礼狐', '灰姑娘狐狸', '灰狐'],
    # =================================== #
    ...
    1801: ['日和(公主)', 'ヒヨリ(プリンセス)', 'Hiyori(Princess)', '公主猫拳', '公猫', '公主日和', '掉毛猫','火猫'],
    ...
    1806: ["凯留(公主)", "キャル（プリンセス）",  "Kiruya(Princess)", "公主黑猫", "公主鼬", "公主黑", "天猫", "飞猫", '公黑猫', '公黑', '公主臭鼬','飞黑','飞天猫猫头','公主猫猫头'],
